...
const EXERCISES = {
  mobility: [
    ...
    { id: "m22", name: "Thread The Needle", category: "mobility", equipment: "none" },
    { id: "m23", name: "Flessioni Spalla Su Rullo", category: "mobility", equipment: "foam roller" },
    { id: "m24", name: "Estensioni Toraciche Su Rullo", category: "mobility", equipment: "foam roller" },
    { id: "m25", name: "Half Kneeling Hip Opener", category: "mobility", equipment: "none" },
    { id: "m26", name: "Happy Baby Pose", category: "mobility", equipment: "none" },
    { id: "m27", name: "Respirazione Diaframmatica", category: "mobility", equipment: "none" },
    { id: "m28", name: "Open Book Stretch", category: "mobility", equipment: "none" },
    { id: "m29", name: "Air Squat", category: "mobility", equipment: "none" },
  ],
  compound_push_squat: [
    ...
    { id: "cps18", name: "Snatch Bilanciere", category: "compound", equipment: "barbell", muscles: ["shoulders", "legs", "back"], focus: "A" },
    { id: "cps19", name: "Clean And Jerk", category: "compound", equipment: "barbell", muscles: ["full body"], focus: "A" },
    { id: "cps20", name: "Landmine Press", category: "compound", equipment: "barbell/landmine", muscles: ["shoulders", "chest"], focus: "A" },
  ],
  compound_pull_hinge: [
    ...
    { id: "cph17", name: "Clean Manubri", category: "compound", equipment: "dumbbells", muscles: ["full body"], focus: "B" },
    { id: "cph18", name: "Clean Bilanciere", category: "compound", equipment: "barbell", muscles: ["full body"], focus: "B" },
  ],
  accessory_push_squat: [
    ...
    { id: "aps28", name: "Alzate Laterali Da Seduta", category: "accessory", equipment: "dumbbells", muscles: ["shoulders"], focus: "A" },
    { id: "aps29", name: "Dip Parallele", category: "accessory", equipment: "parallel bars", muscles: ["chest", "triceps"], focus: "A" },
    { id: "aps30", name: "Affondo Dietro Deficit", category: "accessory", equipment: "dumbbells/step", muscles: ["quads", "glutes"], focus: "A" },
    { id: "aps31", name: "Step Down", category: "accessory", equipment: "box/step", muscles: ["quads", "glutes"], focus: "A" },
    { id: "aps32", name: "French Press", category: "accessory", equipment: "barbell/dumbbells", muscles: ["triceps"], focus: "A" },
    { id: "aps33", name: "Lateral Lunges", category: "accessory", equipment: "dumbbells", muscles: ["quads", "glutes", "adductors"], focus: "A" },
    { id: "aps34", name: "Landmine Shoulder Press", category: "accessory", equipment: "barbell/landmine", muscles: ["shoulders", "triceps"], focus: "A" },
    { id: "aps35", name: "Single Leg Squat", category: "accessory", equipment: "none", muscles: ["quads", "glutes"], focus: "A" },
    { id: "aps36", name: "Shrimp Squat", category: "accessory", equipment: "none", muscles: ["quads", "glutes"], focus: "A" },
  ],
  accessory_pull_hinge: [
    ...
    { id: "aph28", name: "Hyperextension", category: "accessory", equipment: "GHD/bench", muscles: ["lower back", "glutes"], focus: "B" },
    { id: "aph29", name: "Ring Row", category: "accessory", equipment: "rings", muscles: ["back", "biceps"], focus: "B" },
    { id: "aph30", name: "Nordic Hamstring", category: "accessory", equipment: "none", muscles: ["hamstrings"], focus: "B" },
    { id: "aph31", name: "Adductors", category: "accessory", equipment: "machine/band", muscles: ["adductors"], focus: "B" },
    { id: "aph32", name: "Split Row", category: "accessory", equipment: "dumbbells", muscles: ["back", "biceps"], focus: "B" },
    { id: "aph33", name: "Australian Pull-Up", category: "accessory", equipment: "bar/rings", muscles: ["back", "biceps"], focus: "B" },
    { id: "aph34", name: "Pullover", category: "accessory", equipment: "dumbbell/cable", muscles: ["lats", "chest"], focus: "B" },
    { id: "aph35", name: "Hamstring Curls Fitball", category: "accessory", equipment: "fitball", muscles: ["hamstrings", "glutes"], focus: "B" },
    { id: "aph36", name: "Landmine RDL", category: "accessory", equipment: "barbell/landmine", muscles: ["hamstrings", "glutes"], focus: "B" },
  ],
  core: [
    ...
    { id: "co20", name: "Turkish Get Up", category: "core", equipment: "kettlebell" },
    { id: "co21", name: "Kneeling Rainbow", category: "core", equipment: "cable/band" },
    { id: "co22", name: "Feet Elevated Reverse Plank", category: "core", equipment: "box/bench" },
    { id: "co23", name: "Feet Elevated Reverse Plank March", category: "core", equipment: "box/bench" },
    { id: "co24", name: "Crab Walk", category: "core", equipment: "none" },
    { id: "co25", name: "Isometria In Split Tibiale", category: "core", equipment: "none" },
    { id: "co26", name: "Plank Fitball", category: "core", equipment: "fitball" },
    { id: "co27", name: "Stir The Pot Fitball", category: "core", equipment: "fitball" },
    { id: "co28", name: "Wood Chopper", category: "core", equipment: "cable/dumbbell" },
    { id: "co29", name: "Kneeling Halo", category: "core", equipment: "kettlebell" },
    { id: "co30", name: "Wallwalk", category: "core", equipment: "none" },
    { id: "co31", name: "Landmine Halo", category: "core", equipment: "barbell/landmine" },
  ],
  hiit: [
    ...
    { id: "h30", name: "Jumping Jacks", category: "hiit", equipment: "none" },
    { id: "h31", name: "Box Jump Over", category: "hiit", equipment: "box" },
    { id: "h32", name: "Step Up Over", category: "hiit", equipment: "box" },
    { id: "h33", name: "Burpees Plate Jump E Broad Jump", category: "hiit", equipment: "plate" },
    { id: "h34", name: "Sled Pull", category: "hiit", equipment: "sled" },
    { id: "h35", name: "Pogo Jumps", category: "hiit", equipment: "none" },
    { id: "h36", name: "One Leg Landing", category: "hiit", equipment: "box" },
    { id: "h37", name: "Seated High Jump", category: "hiit", equipment: "box/bench" },
    { id: "h38", name: "Drop Jump", category: "hiit", equipment: "box" },
    { id: "h39", name: "Single Leg Hop", category: "hiit", equipment: "none" },
  ],
  running: [
    ...
    { id: "r5", name: "Bike", category: "running", equipment: "bike" },
    { id: "r6", name: "Run", category: "running", equipment: "none" },
    { id: "r7", name: "Row", category: "running", equipment: "rowing machine" },
  ],
};
...
export default function App() {
          ...
          for (let ei = 0; ei < exs.length; ei++) {
            ...
            if (ex.ssGroup) {
              if (ex.ssGroup !== lastSSGroup) {
                ssLetter++; ssIndex = 1; lastSSGroup = ex.ssGroup;
                rows.push([{ content: "SUPERSET " + String.fromCharCode(ssLetter), colSpan: 7, styles: { fillColor: [50, 35, 8], textColor: [240, 160, 48], fontStyle: "bold", fontSize: 7, cellPadding: 1.2 } }]);
              } else { ssIndex++; }
            } else { lastSSGroup = ""; }
  ...
  function ProgEdit({ program, prevProgram, onSave, onPersist, onBack }) {
    ...
    const addExToBlock = (bk, di, sec, ex) => {
      const np = { ...p }; np[bk] = [...np[bk]]; np[bk][di] = { ...np[bk][di] };
    ...
    const ExRow = ({ di, ei, ei2, ex1, ex2, isSSStart, isSSMid, isSSEnd, bk }) => {
      ...
      if (isCompact) {
        return (
          <div draggable onDragStart={e => { dragRef.current = { di, ei }; e.dataTransfer.effectAllowed = "move"; e.currentTarget.style.opacity = "0.4"; }} onDragEnd={e => { e.currentTarget.style.opacity = "1"; dragRef.current = null; setDragOver(null); }} onDragOver={e => { e.preventDefault(); if (!dragOver || dragOver.di !== di || dragOver.ei !== ei) setDragOver({ di, ei }); }} onDragLeave={() => setDragOver(null)} onDrop={e => { e.preventDefault(); if (dragRef.current && dragRef.current.di === di) moveEx(di, dragRef.current.ei, ei); dragRef.current = null; setDragOver(null); }} style={{ background: K.cd, border: isDragTarget ? "2px solid " + K.ac : "1px solid " + K.bd, borderRadius: ssRadius, marginBottom: ssMargin, padding: 10, ...ssStyle, transition: "border 0.15s" }}>
            ...
            <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", gap: 6, marginBottom: 8 }}>
              <div style={{ cursor: "grab", color: K.td, fontSize: 14, padding: "0 4px", userSelect: "none" }}>⠿</div>
              <div style={{ color: K.tx, fontWeight: 500, fontSize: 13, cursor: "pointer", minWidth: 0, overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap", flex: 1 }} onClick={() => setExPk({ di, sec: ex.section, idx: ei, rep: true, bk: targetBk })}>
                {ex.name}
              </div>
      ...
      return (
        <div draggable onDragStart={e => { dragRef.current = { di, ei }; e.dataTransfer.effectAllowed = "move"; e.currentTarget.style.opacity = "0.4"; }} onDragEnd={e => { e.currentTarget.style.opacity = "1"; dragRef.current = null; setDragOver(null); }} onDragOver={e => { e.preventDefault(); if (!dragOver || dragOver.di !== di || dragOver.ei !== ei) setDragOver({ di, ei }); }} onDragLeave={() => setDragOver(null)} onDrop={e => { e.preventDefault(); if (dragRef.current && dragRef.current.di === di) moveEx(di, dragRef.current.ei, ei); dragRef.current = null; setDragOver(null); }} style={{ background: K.cd, border: isDragTarget ? "2px solid " + K.ac : "1px solid " + K.bd, borderRadius: ssRadius, marginBottom: ssMargin, padding: "8px 12px", ...ssStyle, transition: "border 0.15s" }}>
          {isSSStart && <div style={{ fontSize: 9, fontWeight: 700, color: "#f0a030", textTransform: "uppercase", letterSpacing: "0.08em", marginBottom: 4 }}>Superset</div>}
          <div style={{ display: "grid", gridTemplateColumns: bk ? "20px minmax(120px, 1.5fr) minmax(280px, 1fr) 28px" : "20px minmax(100px, 1.2fr) minmax(190px, 1fr) minmax(190px, 1fr) 28px 28px", gap: 8, alignItems: "center" }}>
    ...
    return (
      <div>
              ...
              return (
                <div key={di} style={{ marginBottom: 24 }}>
                  ...
                  {!isCollapsed && <div style={{ border: "1px solid " + K.bd, borderTop: "none", borderRadius: "0 0 10px 10px", padding: isMobile ? 8 : 12 }}>
                    ...
                    {!isCompact && <div style={{ display: "grid", gridTemplateColumns: "20px minmax(100px, 1.2fr) minmax(190px, 1fr) minmax(190px, 1fr) 28px 28px", gap: 8, padding: "0 12px 6px", borderBottom: "1px solid " + K.bd, marginBottom: 8 }}>
                      <span></span>
        ...
        {exPk && <ExPick section={exPk.sec} dayType={(p.block1[exPk.di] || {}).dayType} location={p.trainingLocation || "gym"} onSelect={ex => { const bk = exPk.bk || "block1"; if (exPk.rep && exPk.idx != null) { repEx(exPk.di, exPk.idx, ex, bk); } else { addExToBlock(bk, exPk.di, exPk.sec, ex); } }} onClose={() => setExPk(null)} />}
      </div>
    );
  }
