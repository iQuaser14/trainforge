...
export default function App() {
  ...
  function ExPick({ section, dayType, location, onSelect, onClose }) {
    ...
    const getSectionCats = () => { if (section === "Warm-Up") return ["mobility"]; if (section === "Core") return ["core"]; if (section === "Finisher") return ["hiit"]; if (section === "Strength") { if (dayType === "A" || dayType === "Q") return ["compound_push_squat"]; if (dayType === "B" || dayType === "H") return ["compound_pull_hinge"]; if (dayType === "G") return ["compound_pull_hinge", "accessory_pull_hinge"]; return ["compound_push_squat", "compound_pull_hinge"]; } if (section === "Strength") { if (dayType === "A" || dayType === "Q") return ["accessory_push_squat", "accessory_pull_hinge"]; if (dayType === "B" || dayType === "H") return ["accessory_pull_hinge"]; return ["accessory_push_squat", "accessory_pull_hinge"]; } return Object.keys(EXERCISES); };
